        ...
        <section class="gap-4 flex flex-col w-full items-center">
            <form action="/auth/signup" method="POST" class="flex flex-col justify-center items-center gap-4 w-full">
                ...
                <div class="flex flex-col gap-2">
                    <input type="text" class="tess-input-md" placeholder="Username [3-32]" name="username" required aria-label="Username, 3 to 32 characters">
                ...
                <div class="flex flex-col gap-2">
                    <input type="password" class="tess-input-md" placeholder="Password" name="password" required
                           ...
                           aria-label="Password, must have 1 lowercase, 1 uppercase, 1 digit, no spaces, 12-64 characters">

                    <input type="password" class="tess-input-md" placeholder="Confirm Password" name="password_confirm"
                           required minlength="12" aria-label="Confirm password">
