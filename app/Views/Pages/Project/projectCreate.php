    ...
    <section class="tess-base-container-md">
        ...
        <section class="gap-4 flex flex-col w-full items-center">
            <form action="/project/create" method="POST" class="flex flex-col justify-center items-center gap-2 w-full">
                ...
                <input type="text" class="tess-input-md" placeholder="Project Name [3-32]" name="name" required aria-label="Project name, 3 to 32 characters">
                <textarea class="tess-input-md min-h-32" placeholder="Description [0-128]"
                          name="description" aria-label="Project description, 0 to 128 characters"></textarea>
