...
<main class="flex-1 flex justify-start items-start px-4 py-6 overflow-x-auto">
    <div class="flex gap-4 items-start min-w-max">
        <!-- TODO: Fetch all tasks for the project and pass them to the component through $data -->
        <?php ProjectTaskComp::renderColumns((array)null); ?>
    </div>
</main>
<?php ProjectTaskComp::renderAddTaskModal($data['user']['username'], $data['members']); ?>
